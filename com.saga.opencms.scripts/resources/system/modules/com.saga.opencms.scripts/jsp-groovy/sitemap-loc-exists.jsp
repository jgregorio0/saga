...
<%
    ...
    String tituloScript = "Comprueba que las url generadas por el sitemap";
    String idProceso = "sitemap-loc-exists"; //No utilizar ni espacios en blanco ni caracteres como tildes o similares
    String descripcion = "Script que comprueba que existan todas las urls contenidas en los tag loc del fichero sitemap.xml indicado.";
    ...
    if(ajax!=null){
        ...
        String scriptName = "classes/com/saga/sagasuite/scriptgroovy/SitemapLocExists.groovy";
        ...
        try{
            ...
            groovyObject.invokeMethod("init", new Object[] {cmso, idProceso, url});
%>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <form method="post" id="scriptExecForm">
                        ...
                        <div>
                            <label for="url">Url online del fichero sitemap.xml:</label>
                            <input type="text" id="url" name="url" value="<c:out value='${param.url}'/>" placeholder="http://einformes-matricula.mv69.sagadev/es/preguntas-frecuentes/sitemap.xml"/>
                        </div>
