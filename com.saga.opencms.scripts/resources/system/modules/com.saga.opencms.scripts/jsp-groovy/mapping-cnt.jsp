...
<%
    ...
    String tituloScript = "Mapping content";
    String idProceso = "mapping-content"; //No utilizar ni espacios en blanco ni caracteres como tildes o similares
    String descripcion = "Script que genera un recurso mapeando sus campos a partir de la configuracion programada.";
    ...
    if(ajax!=null){
        ...
        String scriptName = "classes/com/saga/sagasuite/scriptgroovy/MappingCnt.groovy";
        ...
        try{
            ...
            groovyObject.invokeMethod("init", new Object[] { cmso, idProceso, cfg, onlyCheck});
%>
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <form method="post" id="scriptExecForm">
                        ...
                        <div>
                            <label for="cfg">Ruta del fichero de configuración:</label>
                            <input type="text" class="form-control" id="cfg" name="cfg" value="<c:out value='${param.cfg}'/>" placeholder="/system/modules/com.saga.sagasuite.scriptgroovy/elements/import.json">
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" id="onlyCheck" name="onlyCheck" checked> Ejecutar sin modificar recursos
                            </label>
                        </div>
