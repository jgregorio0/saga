...
<%
    ...
    String tituloScript = "Busca recursos";
    String idProceso = "find-resources"; //No utilizar ni espacios en blanco ni caracteres como tildes o similares
    String descripcion = "Script que busca recursos segun la configuracion json.";
    ...
    if(ajax!=null){
        ...
        String scriptName = "classes/com/saga/sagasuite/scriptgroovy/workplace/FindResources.groovy";
        ...
        try{
            ...
            groovyObject.invokeMethod("init", new Object[] { cmso, idProceso, jsonFile});
%>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-9">
                    ...
                    <p>Debe configurarse un json con los siguientes datos</p>
                    <dl>
                        <dt>sourceFolder</dt>
                        <dd>Carpeta de origen.</dd>
                        <dt>targetFolder</dt>
                        <dd>Carpeta de destino.</dd>
                        <dt>sourceType</dt>
                        <dd>Tipo de recurso de origen.</dd>
                        <dt>targetType</dt>
                        <dd>Tipo de recurso de destino.</dd>
                        <dt>targetPattern</dt>
                        <dd>
                            <p>Patrón para el nombre de los nuevos recursos.</p>
                            <p>El valor clave "EQUALS" indica que queremos generar la transformación sobre el mismo recurso de origen. Es el caso en que sourceFolder == targetFolder.</p>
                        </dd>
                        <dt>mapping</dt>
                        <dd>
