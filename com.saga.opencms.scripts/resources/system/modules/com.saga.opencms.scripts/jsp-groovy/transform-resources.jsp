...
<%
    ...
    String tituloScript = "Transforma recursos";
    String idProceso = "transform-resources"; //No utilizar ni espacios en blanco ni caracteres como tildes o similares
    String descripcion = "Script que transforma un recurso en otro migrando sus contenidos.";
    ...
    if(ajax!=null){
        ...
        String scriptName = "classes/com/saga/sagasuite/scriptgroovy/migration/TransformResources.groovy";
