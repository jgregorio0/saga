...
<%@ page import="com.saga.opencms.scripts.SgReportManager" %>
...
<%
    ...
    String tituloScript = "Repara el contenido xml";
    String idProceso = "repair-xml-content"; //No utilizar ni espacios en blanco ni caracteres como tildes o similares
    String descripcion = "Script que repara el contenido xml de múltiples recursos.";
    ...
    if(ajax!=null){
        ...
        // Obtenemos los parametros  rootPath type
        String rootPath = request.getParameter("rootPath");
        String type = request.getParameter("type");
        String exCntPage = request.getParameter("exCntPage");
        ...
        String scriptName = "classes/com/saga/sagasuite/scriptgroovy/RepairXmlContent.groovy";
        ...
        try{
            ...
            groovyObject.invokeMethod("init", new Object[] {
                    cmso, idProceso, rootPath, type, exCntPage, rewrite, publish, onlyCheck});
%>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <form method="post" id="scriptExecForm">
                        ...
                        <div>
                            <label for="rootPath">Ruta del fichero o carpeta:</label>
                            <input type="text" id="rootPath" name="rootPath" value="<c:out value='${param.rootPath}'/>" placeholder="/.content/texto/"/>
                        </div>
                        <div>
                            <label for="type">Tipo de recurso:</label>
                            <input type="text" id="type" name="type" value="<c:out value='${param.type}'/>" placeholder="sgcontentsections"/>
                        </div>
                        <div>
                            <input type="checkbox" id="exCntPage" name="exCntPage" checked/>Excluir containerpage
                        </div>
                        <div>
                            <input type="checkbox" id="rewrite" name="rewrite"/>Reescribir contenidos
                        </div>
                        <div>
                            <input type="checkbox" id="publish" name="publish"/>Publicar
                        </div>
                        <div>
                            <input type="checkbox" id="onlyCheck" name="onlyCheck" checked/>Comprobar sin modificar recursos
                        </div>
