...
<%
    ...
    String tituloScript = "Export mapping content";
    String idProceso = "ex-mapping-content"; //No utilizar ni espacios en blanco ni caracteres como tildes o similares
    String descripcion = "Script que imprime la exportación de los recursos indicados en el fichero de configuracion.";
    ...
    if(ajax!=null){
        ...
        String scriptName = "classes/com/saga/sagasuite/scriptgroovy/ExMappingCnt.groovy";
        ...
        try{
            ...
            groovyObject.invokeMethod("init", new Object[] { cmso, idProceso, cfg});
%>
