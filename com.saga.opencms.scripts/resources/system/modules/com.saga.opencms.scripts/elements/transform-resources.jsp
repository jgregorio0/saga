...
<%
    ...
    String descripcion = "Script que transforma un recurso antiguo a uno nuevo segun la configuración dada.";
    ...
    if(ajax!=null){
        ...
        String scriptName = "classes/com/saga/sagasuite/scriptgroovy/process/TransformResources.groovy";
