...
<%@ page import="org.opencms.xml.page.CmsXmlPage" %>
<%@ page import="org.opencms.xml.page.CmsXmlPageFactory" %>
...
<div class="container-fluid">
	<div class="row clearfix">
		<div class="col-md-12 column">
			<%!
				public boolean contiene(CmsObject cmso, CmsResource resource, String localeStr) throws UnsupportedEncodingException, CmsException {
					...
					CmsXmlPage xmlPage = CmsXmlPageFactory
							.unmarshal(strContent, CmsEncoder.ENCODING_UTF_8, resolver);
					return xmlPage.hasValue("MesInfoHistoric", new Locale("ca"));
				}
			%>
			<%
				...
				List<CmsResource> results = collector.getResults(
						cmso, "allInSubTree", "/serveis/oficina/Noticies/2015.html|xmlpage");
				...
				for (int i = 0; i < results.size(); i++) {
					...
					try {
						contenidoValido = contiene(cmso, resource, "ca");
					} catch (Exception e) {}
					if (contenidoValido) {
